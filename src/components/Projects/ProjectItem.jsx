...
export default function ProjectItem({ img, title, stack, projectLink }) {
  return (
    <div className="relative flex items-center justify-center h-auto w-full shadow-xl shadow-gray-400 group rounded-xl hover:bg-gradient-to-r from-gray-200 to-[#1a243c]">
